        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header d-block text-center">
                    <h5 class="modal-title" id="exampleModalLabel">Создать новое резюме</h5>
                </div>
                <div class="modal-body">
                    <form action="/create/resume" method="POST">
                        ...
                        <div class="form-floating mb-3 col-md-8 col-lg-6 mx-auto">
                            <input type="text" name="title" class="form-control" id="floating-title" placeholder="Название резюме" required>
                            <label for="floating-title">Название резюме</label>
                        </div>
                        <h3 class="text-center my-2">Выберите оформление</h3>
                        {{-- Choose Theme --}}
                        <div class="d-flex">
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <button type="submit" class="btn btn-custom-secondary px-4">Создать новое</button>
                </div>
                </form>
            </div>
        </div>
