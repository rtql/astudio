            ...
            <div class="col-lg-6 col-md-10 mx-auto mx-lg-0">
                ...
                @if (empty($resume->profile->photo))
                    <div class="mb-3 d-flex pe-lg-3 align-items-center">
                        ...
                        <div>
                            ...
                            <input form="edit-form" class="form-control ms-2 @error('photo') is-invalid @enderror" name="photo" type="file" id="photo">
                            @error('photo')
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <form  action="/photo/{{ $resume->slug }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('delete')
                ...
                <div class="d-lg-flex">
                    <div class="form-floating mb-3 half-input pe-lg-3">
                        <input form="edit-form" type="text" name="name" value="{{ $resume->profile->name ?? ""}}" class="form-control" id="floating-name" placeholder="Фамилия" required>
                        <label for="floating-name">Фамилия</label>
                    </div>
                    <div class="form-floating mb-3 half-input pe-lg-3">
                        <input form="edit-form" type="text" name="first_name" value="{{ $resume->profile->first_name ?? ""}}" class="form-control" id="floating-name" placeholder="Имя" required>
                        <label for="floating-name">Имя</label>
                    </div>
                </div>

                <div class="d-lg-flex">
                    <div class="form-floating mb-3 half-input pe-lg-3">
                        <input form="edit-form" type="text" name="surname" value="{{ $resume->profile->surname ?? ""}}" class="form-control" id="floating-name" placeholder="Отчество" required>
                        <label for="floating-name">Отчество</label>
                    </div>
                    <div class="form-floating mb-3 half-input">
                        <input form="edit-form" type="text" value="{{ $resume->profile->job_title ?? ""}}" name="job_title" class="form-control" id="floatingjob_title" placeholder="Должность" required>
                        <label for="floatingjob_title">Должность</label>
                    </div>
                </div>
                ...
                <div class="d-lg-flex">
                    ...
                    <div class="form-floating mb-3 half-input">
                        <input form="edit-form" type="tel" value="{{ $resume->profile->phone ?? ""}}" name="phone" class="form-control" id="floating-phone" placeholder="Телефон" required>
                        <label for="floating-phone">Телефон</label>
                    </div>
                </div>

                <div class="form-floating mb-3">
                    <input form="edit-form" type="text" value="{{ $resume->profile->address ?? ""}}" name="address" class="form-control" id="floating-address" placeholder="Город" required>
                    <label for="floating-address">Город</label>
                </div>

                @if ($resume->theme != 'ats')
                    <div class="form-floating mb-3">
                        <textarea form="edit-form" name="profile_desc" class="form-control" id="profile_desc" placeholder="Описание" required style="height: 150px">{{ $resume->profile->profile_desc ?? ""}}</textarea>
                        <label for="profile_desc">Описание</label>
                    </div>
                @endif
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapse-static" class="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <div class="d-lg-flex">
                                        <div class="form-floating mb-3 half-input pe-lg-3">
                                            <input form="edit-form" type="text" name="school[]" class="form-control" id="floating-school" placeholder="Учебное заведение" required>
                                            <label for="floating-school">Учебное заведение</label>
                                        </div>
                                        <div class="form-floating mb-3 half-input">
                                            <input form="edit-form" type="text" name="degree[]" class="form-control" id="floating-degree" placeholder="Специальность" required>
                                            <label for="floating-degree">Специальность</label>
                                        </div>
                                    </div>
                        
                                    <div class="d-lg-flex">
                                        <div class="mb-3 half-input pe-lg-3">
                                        <label for="start-date-edu-static" class='mb-2'>Начало обучения</label>
                                            <div class="input-group mb-3">
                                                ...
                                                <input form="edit-form" type="text" name="start_date_edu[]" id="start-date-edu-static" class="form-control date-picker" placeholder="Выберите дату" required>
                                            </div>
                                        </div>
                        
                                        <div class="mb-3 half-input">
                                        <label for="end-date-edu-static" class='mb-2'>Окончание</label>
                                            <div class="input-group mb-3">
                                                <label class="input-group-text" for="end-date-edu-static">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="M7 11h2v2H7zm0 4h2v2H7zm4-4h2v2h-2zm0 4h2v2h-2zm4-4h2v2h-2zm0 4h2v2h-2z"></path><path d="M5 22h14c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2h-2V2h-2v2H9V2H7v2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2zM19 8l.001 12H5V8h14z"></path></svg>
                                                </label>
                                                <input form="edit-form" type="text" name="end_date_edu[]" id="end-date-edu-static" class="form-control date-picker" placeholder="Выберите дату" required>
                                            </div>
                                        </div>
                                    </div>
                ...
                <!-- diploma section -->
                <h4 class="mb-4 mt-3">Диплом</h4>
                @if (empty($resume->profile->diploma))
                    <div class="mb-3 d-flex pe-lg-3 align-items-center">
                        <label for="diploma">
                            <img class="preview-diploma" src="/images/diploma.svg" alt="">
                        </label>
                        <div>

                            <input form="edit-form" class="form-control ms-2 @error('diploma') is-invalid @enderror" name="diploma" type="file" id="diploma">
                            @error('diploma')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    @else
                    <div class="d-flex align-items-center">
                        <img class="preview-photo mb-3" src="{{ Storage::url($resume->profile->diploma) }}" alt="" >
                        <div>
                            <form  action="/diploma/{{ $resume->slug }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('delete')
                                <button type="submit" class="delete-draft ps-3 py-1 ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 14 14" fill="none">
                            ...
                            <div class="ps-3 py-1 edit-photo-btn">
                                ...
                                <input form="edit-form" class="edit-photo-input d-none form-control @error('diploma') is-invalid @enderror" name="diploma" type="file" id="diploma">
                                @error('diploma')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div id="collapse-exp-static" class="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <div class="d-lg-flex">
                                        ...
                                        <div class="form-floating mb-3 half-input pe-lg-3">
                                            <input form="edit-form" type="text" name="employer[]" class="form-control" id="floating-school" placeholder="Организация" required>
                                            <label for="floating-school">Организация</label>
                                        </div>
                                        <div class="form-floating mb-3 half-input">
                                            <input form="edit-form" type="text" name="job[]" class="form-control" id="floating-degree" placeholder="Должность" required>
                                            <label for="floating-degree">Должность</label>
                                        </div>
                                    </div>
                        
                                    <div class="d-lg-flex">
                                        <div class="mb-3 half-input pe-lg-3">
                                        <label for="start-date-exp-static" class='mb-2'>Начало работы</label>
                                            <div class="input-group mb-3">
                                                <label class="input-group-text" for="start-date-exp-static">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="M7 11h2v2H7zm0 4h2v2H7zm4-4h2v2h-2zm0 4h2v2h-2zm4-4h2v2h-2zm0 4h2v2h-2z"></path><path d="M5 22h14c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2h-2V2h-2v2H9V2H7v2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2zM19 8l.001 12H5V8h14z"></path></svg>
                                                </label>
                                                <input form="edit-form" type="text" name="start_date_exp[]" id="start-date-exp-static" class="form-control date-picker" placeholder="Выберите дату">
                                            </div>
                                        </div>
                        
                                        <div class="mb-3 half-input">
                                        <label for="end-date-exp-static" class='mb-2'>Окончание</label>
                                            <div class="input-group mb-3">
                                                <label class="input-group-text" for="end-date-exp-static">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="M7 11h2v2H7zm0 4h2v2H7zm4-4h2v2h-2zm0 4h2v2h-2zm4-4h2v2h-2zm0 4h2v2h-2z"></path><path d="M5 22h14c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2h-2V2h-2v2H9V2H7v2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2zM19 8l.001 12H5V8h14z"></path></svg>
                                                </label>
                                                <input form="edit-form" type="text" name="end_date_exp[]" id="end-date-exp-static" class="form-control date-picker" placeholder="Выберите дату">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="floating-description">Описание</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="collapse-skill-static" class="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                <div class="d-lg-flex">
                                    ...
                                    <div class="form-floating mb-3 half-input pe-lg-3">
                                        <input form="edit-form" type="text" name="skill[]" class="form-control" id="floating-skill" placeholder="Навык" required>
                                        <label for="floating-skill">Навык</label>
                                    </div>
                ...
                {{-- End Skill --}}
                <button type="submit" class="btn btn-custom mt-4" form="edit-form">Сохранить</button>
            ...
            <div class="col-lg-6 preview">
                <div class="preview-wrapper">
                    ...
                    @include("themes.$resume->theme", [
                        ...
                        'first_name' => $resume->profile->first_name,
                        'surname' => $resume->profile->surname,
                        ...
                        'diploma' => $resume->profile->diploma,
