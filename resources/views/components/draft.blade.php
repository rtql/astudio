<div class="draft">
    ...
    <div class="content">
        <h4>{{ $title }}</h4>
        @isset($date)
            <small class="mb-2">Обновлено {{ $date }}</small>
        @endisset
        @isset($name)
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header d-block text-center">
                                ...
                                <h2 class="modal-title" id="exampleModalLabel">Удаление резюме</h2>
                                <p>Подтвердите удаление <span class="fw-bold">{{ $title }}</span></p>
                            </div>
