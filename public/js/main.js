...
document.querySelector(".edit-photo-input").onchange = function(){
    document.querySelector(".new-filename").textContent = "Файл изменится на : " + this.files[0].name;
}
    ...
    <div id="collapse-js-${i}" class="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            ...
            <div class="d-lg-flex">
                ...
                <label for="start-date-edu-js-${i}" class='mb-2'>Начало обучения</label>
                    <div class="input-group mb-3">
                        ...
                        <input form="edit-form" type="text" name="start_date_edu[]" id="start-date-edu-js-${i}" class="form-control date-picker" placeholder="Выберите дату">
                    </div>
                </div>

                <div class="mb-3 half-input">
                <label for="end-date-edu-js-${i}" class='mb-2'>Окончание</label>
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="end-date-edu-js-${i}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="M7 11h2v2H7zm0 4h2v2H7zm4-4h2v2h-2zm0 4h2v2h-2zm4-4h2v2h-2zm0 4h2v2h-2z"></path><path d="M5 22h14c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2h-2V2h-2v2H9V2H7v2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2zM19 8l.001 12H5V8h14z"></path></svg>
                        </label>
                        <input form="edit-form" type="text" name="end_date_edu[]" id="end-date-edu-js-${i}" class="form-control date-picker" placeholder="Выберите дату">
                    </div>
                </div>
            </div>
...
function experienceItemComp(j){
    ...
    <div id="collapse-js-${j}" class="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            ...
            <div class="d-lg-flex">
                <div class="mb-3 half-input pe-lg-3">
                <label for="start-date-exp-js-${i}" class='mb-2'>Начало работы</label>
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="start-date-exp-js-${i}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="M7 11h2v2H7zm0 4h2v2H7zm4-4h2v2h-2zm0 4h2v2h-2zm4-4h2v2h-2zm0 4h2v2h-2z"></path><path d="M5 22h14c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2h-2V2h-2v2H9V2H7v2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2zM19 8l.001 12H5V8h14z"></path></svg>
                        </label>
                        <input form="edit-form" type="text" name="start_date_exp[]" id="start-date-exp-js-${i}" class="form-control date-picker" placeholder="Выберите дату">
                    </div>
                </div>

                <div class="mb-3 half-input">
                <label for="end-date-exp-js-${i}" class='mb-2'>Окончание</label>
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="end-date-exp-js-${i}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="M7 11h2v2H7zm0 4h2v2H7zm4-4h2v2h-2zm0 4h2v2h-2zm4-4h2v2h-2zm0 4h2v2h-2z"></path><path d="M5 22h14c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2h-2V2h-2v2H9V2H7v2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2zM19 8l.001 12H5V8h14z"></path></svg>
                        </label>
                        <input form="edit-form" type="text" name="end_date_exp[]" id="end-date-exp-js-${i}" class="form-control date-picker" placeholder="Выберите дату">
                    </div>
                </div>
            </div>

            <div class="form-floating mb-3">
                <textarea form="edit-form" name="experience_desc[]" class="form-control" id="floating-description" placeholder="Описание" required style="height: 150px"></textarea>
